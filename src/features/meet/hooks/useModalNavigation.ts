/**
 * USEMODALNAVIGATION - Hook para control de navegación entre secciones
 * Encapsula toda la lógica de navegación, búsqueda y estado del selector
 * 
 * Características:
...
export const useModalNavigation = ({
  ...
  enableHistory = true,
  persistState = false,
  storageKey = 'modal-navigation-state',
