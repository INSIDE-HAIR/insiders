/**
 * ParticipantCard - Molecular Component
 * 
 * Card IDÉNTICO estéticamente al original ParticipantKPICard.tsx
 * + Estado de loading con skeleton
 * Copiado exacto de: ParticipantKPICard.tsx líneas completas 77-374
 */
...
export const ParticipantCard: React.FC<ParticipantCardProps> = ({
  ...
  // Get initials from displayName or email - copiado exacto líneas 32-42
  const getInitials = () => {
    if (kpi.displayName) {
  ...
  // Loading skeleton - copiado exacto líneas 48-68
  if (isLoading) {
    return (
  ...
  // Calculate response distribution percentages - copiado exacto líneas 70-75
  ...
  return (
    <Card className="relative hover:bg-muted/10 transition-colors border-2">
      ...
      <CardContent className="space-y-4">
        {/* Total de sesiones - copiado exacto líneas 104-113 */}
        ...
        {/* Total de duración - copiado exacto líneas 115-124 */}
        <div className="flex items-center justify-between bg-muted/20 p-2 rounded-md">
          <div className="flex items-center gap-2">
        ...
        {/* Estado de respuestas - copiado exacto líneas 126-166 */}
        ...
        {/* Estado de realización - copiado exacto líneas 168-197 */}
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs">
        ...
        {/* Tasa de aceptación - copiado exacto líneas 199-255 */}
        {(() => {
        ...
        {/* Tasa de sesiones - copiado exacto líneas 257-313 */}
        {(() => {
        ...
        {/* Tasa de respuestas - copiado exacto líneas 315-371 */}
        {(() => {
