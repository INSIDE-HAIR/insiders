 ...
 *
 * @param {ContentItem[]} items - Lista de elementos de pestaña
 ...
 */
export function TabNavigation({ items, level, currentId }: TabNavigationProps) {
  ...
  const handleTabClick = (item: ContentItem) => {
    addToNavigationPath({
      id: item.id,
      type: "tab",
      level: level,
  ...
  }, [currentId, activeAndOrderedTabs]);
 ...
 *
 * @param {ContentItem} item - Elemento a verificar
