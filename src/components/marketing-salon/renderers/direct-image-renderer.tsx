...
import { hasDownloadSuffix } from "@/src/lib/utils/marketing-salon/content-type-utils";
 ...
 *
 * @param {ContentItem} item - Elemento de contenido que contiene la información de la imagen
...
export function DirectImageRenderer({ item }: DirectImageRendererProps) {
  ...
  const hasPreview = item.transformedUrl && item.transformedUrl.preview;
  ...
  return (
    <div className='w-full flex flex-col items-center my-4'>
      ...
      <div className='relative max-w-full overflow-hidden'>
        ...
        {/* Imagen principal */}
        <img
          src={item.transformedUrl!.preview || "/placeholder.svg"}
        ...
        {!isLoading && canDownload && item.transformedUrl?.download && (
          <a
