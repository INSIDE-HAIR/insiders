 ...
 *
 * @param {ContentItem} item - Elemento de contenido que contiene la información del video
  ...
  if (!vimeoId) {
    return (
      <div className="p-4 bg-zinc-800 text-zinc-300">
        <p className="mb-2">No se pudo determinar el ID de Vimeo para este archivo.</p>
        <p className="text-sm">Sugerencia: Nombra el archivo incluyendo el ID de Vimeo (ej: vimeo_123456789.txt)</p>
      </div>
    )
  }
