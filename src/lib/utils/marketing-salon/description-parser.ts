 ...
 */
export function extractPropertyFromDescription(item: ContentItem, propertyName: string): string | null {
  ...
  try {
    ...
    console.error(`Error parsing description for property ${propertyName}:`, error)
    return null
  }
}
