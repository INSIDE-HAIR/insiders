...
export function extractFormUrl(item: ContentItem): string | null {
  return extractPropertyFromDescription(item, "formUrl");
}

// Extraer texto para copiar
export function extractCopyText(item: ContentItem): string | null {
...
export function GoogleFormRenderer({ item }: { item: ContentItem }) {
...
export function MiComponente({ item }: { item: ContentItem }) {
