...
ContentLayout
  ...
  └── ContentRenderer → RecursiveContentRenderer
        ...
        <h3 className='text-xl font-semibold mt-6 mb-3'>
          Estructura de datos de ContentItem
        </h3>

        <p className='mb-4'>
          La interfaz <code>ContentItem</code> define la estructura de datos que
          se pasa a través de los componentes:
        </p>
 ...
 children?: ContentItem[]    // Elementos hijos (para carpetas)
...
export function determineComponentType(item: ContentItem): string {
 ...
 // Resto de la lógica existente...
        ...
        <p className='mb-4'>
          ...
          interfaz <code>ContentItem</code>:
        </p>
  ...
  previewItems?: ContentItem[]  // Array de elementos que sirven como previsualizaciones
...
const GenericRenderer = ({ item }: { item: ContentItem }) => {
