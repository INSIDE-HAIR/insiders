...
- 01: Número de archivo`}
        ...
        <div className='bg-amber-50 border-l-4 border-amber-500 p-4 my-6'>
          <p className='text-amber-800'>
            <strong>Importante:</strong> Seguir estas convenciones de
            nomenclatura es esencial para que la plataforma pueda interpretar
            correctamente el contenido y mostrarlo de forma adecuada.
          </p>
        </div>
      </DocContent>
    </div>
