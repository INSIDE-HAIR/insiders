...
export default function Footer() {
  ...
  return (
    <footer className='bg-background border-t border-border text-muted-foreground col-span-full'>
          ...
          <div className='col-span-full lg:col-span-1 mb-8 lg:mb-0'>
            <Link href='/' className='inline-block mb-4'>
              <Image
                src={
                  logoSrc ||
                  "https://source.unsplash.com/random/150x40?Logo+Minimalist"
                }
            ...
            <p className='text-sm'>
              Transformamos dueños de salones en empresarios de éxito.
            </p>
            <Link
              href='/dashboard'
