  ...
  const loadStats = async () => {
    try {
      ...
      toast({
        ...
        description:
          error.message || "No se pudieron cargar las estadísticas de API Keys",
        variant: "destructive",
      });
    }
  };
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
      <Card>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <Key className='h-6 w-+ text-primary bg-primary/20 p-0.5' />
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <Activity className='h-6 w-+ text-primary bg-primary/20 p-0.5' />
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <Shield className='h-6 w-+ text-primary bg-primary/20 p-0.5' />
        </CardHeader>
        <CardContent>
          ...
          <div className='flex items-center space-x-2'>
            <div className='text-sm text-warning'>{stats.inactive}</div>
            <div className='text-xs text-muted-foreground'>inactivas</div>
            <div className='text-sm text-destructive'>{stats.revoked}</div>
      ...
      <Card>
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <Clock className='h-6 w-+ text-primary bg-primary/20 p-0.5' />
        </CardHeader>
        <CardContent>
    ...
    <div className='flex flex-col sm:flex-row gap-4'>
      <div className='flex-1'>
        <div className='relative'>
          <Search className='absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-+ text-primary bg-primary/20 p-0.5' />
          <Input
    ...
    return (
      <div className='flex items-center justify-between'>
        <p className='text-sm text-muted-foreground'>
          Mostrando {(currentPage - 1) * 12 + 1} a{" "}
          {Math.min(currentPage * 12, totalKeys)} de {totalKeys} API Keys
        </p>
        <div className='flex items-center space-x-2'>
          <Button
            variant='outline'
