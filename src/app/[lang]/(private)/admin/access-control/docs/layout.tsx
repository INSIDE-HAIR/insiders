...
import { AuthNavigationSidebar } from "@/src/components/auth/docs/auth-navigation-sidebar";

interface AuthDocsLayoutProps {
  children: ReactNode;
}

export default function AuthDocsLayout({ children }: AuthDocsLayoutProps) {
  return (
