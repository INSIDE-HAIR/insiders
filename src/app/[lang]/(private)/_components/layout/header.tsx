...
function Header({ type, homeLabel, dropdownSliceEnd, separator }: HeaderProps) {
  return (
    <TailwindGrid fullSize>
      <header className='h-14 lg:h-[60px] align-middle justify-between content-center gap-0 max-w-full col-start-1 col-end-full flex items-center bg-background col-span-full'>
        {separator && (
