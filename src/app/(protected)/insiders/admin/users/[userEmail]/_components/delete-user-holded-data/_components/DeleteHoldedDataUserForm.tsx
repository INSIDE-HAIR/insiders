...
import { deleteUserHoldedData } from "@/src/lib/server-actions/auth/user/settings/user-holded-data-delete";
import {
  Form,
  FormControl,
  FormField,
      ...
      <Form {...form}>
        <form className="space-y-4">
          ...
          <Button
            className="w-full"
            disabled={loading}
            onClick={() => onSubmitHoldedDeleteData({ confirmation: form.getValues().confirmation })}
          >
