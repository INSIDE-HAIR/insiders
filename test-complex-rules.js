...
console.log(
  `   Operador Principal: ${complexAccessControlExample.mainLogicOperator}`
);
console.log(
  `   Grupos de Reglas: ${complexAccessControlExample.ruleGroups.length}`
);
console.log("");
...
const testCases = [
  {
    ...
    expected:
      "PERMITIDO - Grupo 'Acceso por Edición Activa' → Regla 'Edición Enero 2025'",
  },
  {
  ...
  },
  {
    ...
    expected:
      "PERMITIDO - Grupo 'Acceso por Servicio Premium' → Regla 'Cliente Activo Premium'",
  },
  {
    name: "✅ Cliente Inactivo - Período Gracia",
    user: {
    ...
    expected:
      "PERMITIDO - Grupo 'Acceso por Servicio Premium' → Regla 'Cliente Inactivo Período Gracia'",
  },
  {
...
console.log(
  '   │   │   ├── user.groups CONTAINS "marketing_digital_enero_2025"'
);
console.log("   │   │   └── current_date BETWEEN 2025-01-15 y 2025-03-15");
console.log('   │   └── Regla: "Edición Abril 2025" (AND)');
console.log(
  '   │       ├── user.groups CONTAINS "marketing_digital_abril_2025"'
);
...
console.log(
  '       │   ├── user.services CONTAINS "marketing_digital_premium"'
);
...
console.log(
  "   ✅ Schema DB extendido (RuleGroup, ComplexRule, RuleCondition)"
);
...
console.log(
  "   GET    /api/admin/complex-access-control - Listar controles complejos"
);
console.log(
  "   POST   /api/admin/complex-access-control - Crear control complejo"
);
console.log(
  "   PUT    /api/admin/complex-access-control - Actualizar control complejo"
);
console.log(
  "   DELETE /api/admin/complex-access-control - Eliminar controles complejos"
);
console.log(
